            ...
            <div className="container auth-container">
                <div className="auth-card-wrapper slide-up">
                    ...
                    <div className="auth-form-panel">
                        ...
                        {error && <div className="auth-error" style={{ color: '#ff4d4d', marginBottom: '15px', fontSize: '0.9rem', background: 'rgba(255, 77, 77, 0.1)', padding: '10px', borderRadius: '8px' }}>{error}</div>}
