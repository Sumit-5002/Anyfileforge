import {
    FileText, Scissors, Zap, FileJson, FileSpreadsheet,
    Presentation, FileEdit, FileSearch, Lock, Unlock,
    RotateCw, Hash, FilePlus, ShieldAlert, FileClock,
    Search, FileCheck, Layers, Layout, Image,
    Maximize, Crop, RefreshCcw, Type, Smile,
    Eraser, EyeOff, Globe, Code, Wand2,
    Download, Play, Star, ArrowRight, Github,
    FileImage, FileVideo, Shield, Music, Smartphone
} from 'lucide-react';
