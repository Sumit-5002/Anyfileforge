                ...
                {isImg && itemUrl ? (
                    <>
                        ...
                        <div className="artifact-overlay">
                            <button className="artifact-btn artifact-btn-view" onClick={() => window.open(itemUrl, '_blank', 'noopener,noreferrer')} title="Inspect Full Resolution" aria-label="Inspect full resolution"><Eye size={20}/></button>
                            <button className="artifact-btn artifact-btn-download" onClick={handleDownload} title="Commence Download" aria-label="Download result file"><Download size={20}/></button>
                        </div>
                    </>
                ) : (
                    <div className="binary-stream-placeholder">
                        ...
                        <div className="artifact-overlay">
                            <button className="artifact-btn artifact-btn-download" onClick={handleDownload} aria-label="Download result file">
                                <Download size={20}/>
                            </button>
                        </div>
                    </div>
